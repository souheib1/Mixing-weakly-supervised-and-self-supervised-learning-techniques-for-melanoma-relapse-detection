...
def main():
    ...
    # Acess to data
    PATH_TRAIN = "./embeddings_resnet_balanced/trainB"
    PATH_TEST = "./embeddings_resnet_balanced/valid_csv"
    ...
    torch.save(mil_network.state_dict(), './mil_network_weights_dataBalance.pth')
    
    # Save the training loss values
    with open('./train_loss.pkl_dataBalance', 'wb') as file:
        dump(train_loss_dict, file)
    
    # Save the validation loss values
    with open('./val_loss.pkl_dataBalance', 'wb') as file:
        dump(val_loss_dict, file)
    
    # Save the accuracy values  
    with open('./accuracy_val.pkl_dataBalance', 'wb') as file:
